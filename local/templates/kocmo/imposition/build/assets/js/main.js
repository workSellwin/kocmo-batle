...
var MainJs = {
    ...
    fancyboxPopupOverflow: function fancyboxPopupOverflow() {
    ...
    fancyboxVacancyPopup: function fancyboxVacancyPopup() {
    ...
    newsSliderInit: function newsSliderInit() {
        var _this = this,
    ...
    sliderCounter: function sliderCounter(swiperSlider, wrapper) {
    ...
    giftSliderInit: function giftSliderInit() {
        var _this = this,
    ...
    customSelectResetInit: function customSelectResetInit() {
    ...
    customSelectFieldInit: function customSelectFieldInit() {
    ...
    breadcrumbsWidth: function breadcrumbsWidth() {
        var width = 0;
    ...
    asideNavActiveInit: function asideNavActiveInit() {
        $('.aside-nav__lnk--active').closest(this.asideNav).find(this.asideNavTitle).trigger('click');
    },
    ...
    asideNavAccordion: function asideNavAccordion() {
    ...
    vacanciesAccordion: function vacanciesAccordion() {
        var _this = this;
    ...
    counterInit: function counterInit() {
        var _this = this;
    ...
    productFormSubmit: function productFormSubmit() {
    ...
    productElementsMove: function productElementsMove() {
    ...
    tabColumnsBtnMoreInit: function tabColumnsBtnMoreInit() {
    ...
    brandsInnerBtnMoreInit: function brandsInnerBtnMoreInit() {
    ...
    loyaltyBtnMoreInit: function loyaltyBtnMoreInit() {
    ...
    reviewMore: function reviewMore() {
    ...
    preorderSetColor: function preorderSetColor() {
    ...
    fieldRequiredInit: function fieldRequiredInit() {
    ...
    cleanReadOnlyAttributes: function cleanReadOnlyAttributes() {
    ...
    basketItemCloseInit: function basketItemCloseInit() {
    ...
    basketRadioInit: function basketRadioInit() {
        this.basketRadioCheck();

        this.basketRadio.on('change', this.basketRadioCheck.bind(this));
    },

    basketRadioCheck: function basketRadioCheck() {
    ...
    headerBasketItemCloseInit: function headerBasketItemCloseInit() {
        $(document).on('click', this.headerBasketItemClose, function () {
            $(this).closest('.header-basket__item').remove();
        });
    },

    headerBasketScrollInit: function headerBasketScrollInit() {
    ...
    cabinetOrdersAccordion: function cabinetOrdersAccordion() {
        var _this = this;
    ...
    productsItemRemoveInit: function productsItemRemoveInit() {
    ...
    filterDropDownInit: function filterDropDownInit() {
        this.filterDropDown.jScrollPane({
            autoReinitialise: true
        });
    },

    sliderPointerSetPriceInit: function sliderPointerSetPriceInit() {
        this.sliderPointerSetPriceAnimation();

        this.sliderPointerSetPrice.on('change', this.sliderPointerSetPriceAnimation.bind(this));
    },

    sliderPointerSetPriceAnimation: function sliderPointerSetPriceAnimation(e) {
    ...
    animateNumber: function animateNumber(element, value) {
...
var Filter = {
    ...
    filterAccordionInit: function filterAccordionInit() {
        var _this = this;

        $(document).on('click', this.filterAccordion, function () {
            $(_this.filterAccordion).not($(this)).closest('.category-filter__item').removeClass('category-filter__item--active');
            $(this).closest('.category-filter__item').toggleClass('category-filter__item--active');
        });

        //reset accordion
        $(document).on('click', function (e) {
            if (!$(e.target).closest('.category-filter__item').length && $('.category-filter__item').hasClass('category-filter__item--active')) {
                e.preventDefault();
    ...
    filterWatchingFieldsInit: function filterWatchingFieldsInit() {
        var _this = this;
    ...
    filterRemoveActiveFields: function filterRemoveActiveFields(el) {
        this.filterActiveField.find(this.filterActiveItem + "[data-name=" + el.name + "]").remove();
    },

    filterAddActiveFields: function filterAddActiveFields(el) {
    ...
    filterCheckActiveFieldsLength: function filterCheckActiveFieldsLength() {
    ...
    filterItemIsActive: function filterItemIsActive(el) {
        return !!this.filterActiveField.find(this.filterActiveItem + "[data-name=" + el.name + "]").length;
    },

    closeBtnInit: function closeBtnInit() {
        var _this = this;
...
var ProductColor = {
    ...
    productColorInit: function productColorInit() {
    ...
    productColorSetActive: function productColorSetActive(e) {
        var _this = this;
...
var DiscountCard = {
    ...
    discountCardAJAX: function discountCardAJAX() {
        var _this = this;
        ...
        $(document).on('click', this.btnStepOne, function () {
            ...
            $.ajax({
                url: 'discount-card-ajax-step-two.php',
                dataType: 'html',
        ...
        $(document).on('click', this.btnStepTwo, function () {
            ...
            let cart = +document.querySelector('input[name="card-number"]').value;
            ...
            $.ajax({
                url: 'discount-card-ajax-step-three.php?card=' + cart,
                dataType: 'html',

                success: function success(response) {
                    $(_this.discountCardWrap).html(response);
                    $('.form-field__input[name="sms-code"]').inputmask("******");
                    $preloader.removeClass('preloader--active');
                },
        ...
        $(document).on('click', this.btnStepThree, function () {
            ...
            //return '';
            $preloader.addClass('preloader--active');
            let code = document.querySelector('input[name="sms-code"]').value;
            ...
            console.log(code);
            $.ajax({
                url: 'discount-card-ajax-step-four.php?code=' + code,
                dataType: 'html',
        ...
        $(document).on('click', this.btnStepFour, function () {
            ...
            $.ajax({
                url: 'discount-card-ajax-step-one.php',
                dataType: 'html',
    ...
    ajaxError: function ajaxError(jqXHR, exception) {
        var msg = '';
...
var LoyaltySale = {
    ...
    loyaltySaleAJAX: function loyaltySaleAJAX() {
        var _this = this;
